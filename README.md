...
### 🏋️ 动作库
按板块管理训练动作，支持新建、编辑、收起和展开。每个动作可绑定多个目标肌群，并填写简要说明，方便快速复用。

### 📋 健身记录表
用类似 Notion 的表格方式记录训练数据，支持日期、标签、多标签、文本、数字、链接和复选框列。支持新增行、增删列、排序和自动换行。

### 🔥 肌肉热力图
根据记录中选择的动作，自动统计肌群出现次数，并在正面 / 背面视图中展示热力强度。

### 🧩 可配置视图
支持自定义数据文件路径、视图标题，以及启动时自动打开健身记录视图。

### ⚡ 快捷操作
支持功能区按钮、命令面板打开视图，也可以直接新增一条健身记录行。
